...
export const VARIANT_STYLES = {
  solid: {
    ...
    typography: { color: 'gray7', wrap: 'nowrap' },
  },
  solidHover: {
    fill: { type: 'solid', color: 'gray2', opacity: 1 },
    stroke: { type: 'none' },
    autoLayout: { flow: 'vertical', gap: 8 },
    typography: { color: 'gray3', wrap: 'nowrap' },
  },
  solidActive: {
    fill: { type: 'solid', color: 'primary4', opacity: 1 },
    stroke: { type: 'none' },
    autoLayout: { flow: 'vertical', gap: 8 },
