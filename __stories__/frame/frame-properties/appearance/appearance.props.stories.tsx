...
export const Appearance: AppearanceStory = {
  ...
  render: (args: AppearanceArgs) => (
      ...
      >
        <Frame
          stroke={{ type: 'none' }}
          typography={{ color: '#374151', fontSize: 14, fontWeight: 700, textAlign: 'center' }}
        >
          {args.children}
        </Frame>
        ...
        <Frame
          ...
          stroke={{type:'solid', color:'primary12', weight: 1 }}
          typography={{color: 'primary12'}}
          
          autoLayout={{flow:'horizontal', alignment:'center', width: 'fill', height: 'hug', paddingHorizontal:16}}
          appearance={{
        ...
        <Frame
          ...
          stroke={{type:'solid', color:'error12', weight: 1 }}
          typography={{color: 'error12'}}
          autoLayout={{flow:'horizontal', alignment:'center', width: 100, height: 50}}
          appearance={{
