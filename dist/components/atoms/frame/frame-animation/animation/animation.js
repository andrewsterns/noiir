...
export function getAnimationStyles(animation, direction, curve, duration) {
...
function getTransformForDirection(direction, animation) {
    const distance = '100%';
...
export function applyAnimation(element, config, isEntering = true) {
    const styles = getAnimationStyles(config.type, config.direction, config.curve, config.duration);
