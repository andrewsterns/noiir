...
export const Fill = {
    ...
    render: (args) => {
        ...
        return (_jsxs(Frame, { fill: fillProps, appearance: args.appearance, autoLayout: {
                flow: 'vertical',
                alignment: 'center',
                gap: 16,
                padding: 24,
                width: 280,
                height: 200
            }, children: [_jsx(Frame, { typography: {
                        color: hasNoFill || isLightFill ? 'neutral9' : 'white',
                        fontSize: 18,
                        fontWeight: 700,
                        textAlign: 'center'
                    }, children: args.children }), _jsxs(Frame, { typography: {
