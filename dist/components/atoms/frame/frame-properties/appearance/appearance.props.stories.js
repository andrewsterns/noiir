...
export const Appearance = {
    ...
    render: (args) => (_jsxs(Frame, { fill: args.fill, stroke: args.stroke, appearance: {
            ...
            width: 300,
            height: 200
        }, children: [_jsx(Frame, { stroke: { type: 'none' }, typography: { color: '#374151', fontSize: 14, fontWeight: 700, textAlign: 'center' }, children: args.children }), _jsx(Frame, { fill: { type: 'solid', color: 'primary6' }, stroke: { type: 'solid', color: 'primary12', weight: 1 }, typography: { color: 'primary12' }, autoLayout: { flow: 'horizontal', alignment: 'center', width: 'fill', height: 'hug', paddingHorizontal: 16 }, appearance: {
                ...
                }, children: "Child Frame" }), _jsx(Frame, { fill: { type: 'solid', color: 'error6' }, stroke: { type: 'solid', color: 'error12', weight: 1 }, typography: { color: 'error12' }, autoLayout: { flow: 'horizontal', alignment: 'center', width: 100, height: 50 }, appearance: {
