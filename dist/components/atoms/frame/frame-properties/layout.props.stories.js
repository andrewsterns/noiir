...
export const Layout = {
    ...
    render: (args) => (_jsxs(Frame, { autoLayout: args.flow ? {
            ...
            width: args.width,
            height: args.height
        } : undefined, fill: args.fill, stroke: args.stroke, appearance: args.appearance, children: [_jsx(Frame, { fill: { type: 'solid', color: 'primary6' }, autoLayout: {
                    width: args.childWidth,
                    height: args.childHeight,
                    alignment: args.childAlignment
                }, appearance: { radius: 4 }, children: _jsx("div", { style: { color: 'white', padding: '8px', fontSize: '10px', textAlign: 'center' }, children: "Item 1" }) }), _jsx(Frame, { fill: { type: 'solid', color: 'error6' }, autoLayout: {
                    width: args.childWidth,
                    height: args.childHeight,
                    alignment: args.childAlignment
                }, appearance: { radius: 4 }, children: _jsx("div", { style: { color: 'white', padding: '8px', fontSize: '10px', textAlign: 'center' }, children: "Item 2" }) }), _jsx(Frame, { fill: { type: 'solid', color: 'success6' }, autoLayout: {
                    width: args.childWidth,
                    height: args.childHeight,
                    alignment: args.childAlignment
                }, appearance: { radius: 4 }, children: _jsx("div", { style: { color: 'white', padding: '8px', fontSize: '10px', textAlign: 'center' }, children: "Item 3" }) }), _jsx(Frame, { fill: { type: 'solid', color: 'accent6' }, autoLayout: {
                    width: args.childWidth,
                    height: args.childHeight,
                    alignment: args.childAlignment
                }, appearance: { radius: 4 }, children: _jsx("div", { style: { color: 'white', padding: '8px', fontSize: '10px', textAlign: 'center' }, children: "Item 4" }) }), _jsx(Frame, { fill: { type: 'solid', color: 'warning6' }, autoLayout: {
                    width: args.childWidth,
                    height: args.childHeight,
                    alignment: args.childAlignment
                }, appearance: { radius: 4 }, children: _jsx("div", { style: { color: 'white', padding: '8px', fontSize: '10px', textAlign: 'center' }, children: "Item 5" }) })] })),
    parameters: {
        docs: {
            description: {
