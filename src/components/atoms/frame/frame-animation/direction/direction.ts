...
export function getDirectionTransform(direction: AnimationDirection, animationType: string = 'slide'): string {
  switch (direction) {
    case 'none':
...
export function isValidDirectionForAnimation(direction: AnimationDirection, animationType: string): boolean {
...
export function getOppositeDirection(direction: AnimationDirection): AnimationDirection {
  switch (direction) {
    case 'left':
      return 'right';
    case 'right':
...
export function getAvailableDirections(): AnimationDirection[] {
